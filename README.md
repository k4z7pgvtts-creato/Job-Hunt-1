...
<div align="center">
  <h1 align="center">Job Hunt</h1>
</div>
<h4>
    Job Hunt an free and open source platform, designed to help job seekers find suitable employment opportunities and employers post job listings efficiently.
...
- [flask](https://www.python.org/) - ai Framework
- [scikit-learn](https://scikit-learn.org/stable/) - ML library
- [TF-IDF](https://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.TfidfTransformer.html) - text vectorization
- [Cosine Similarity](https://www.geeksforgeeks.org/dbms/cosine-similarity/) - Similarity Measure
- [localhost](http://192.168.149.1:5137/) - deployment

## Getting Started

### Prerequisites

Here's what you need to be able to run Job Hunt :
...
Job HUnt is an open-source project and we welcome contributions from the community.
